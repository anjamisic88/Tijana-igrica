...
var comtrade = document.getElementById('rot');
var david = document.getElementById('pit');
var milos = document.getElementById('doberman');
var damjan = document.getElementById('civava');
var ljilja = document.getElementById('separd');
var srecko = document.getElementById('kane');
...
var dug1 = document.getElementById('dugme1');
var dug2 = document.getElementById('dugme2');
var dug3 = document.getElementById('dugme3');
var dug4 = document.getElementById('dugme4');
var dug5 = document.getElementById('dugme5');
var dug6 = document.getElementById('dugme6');
...
doberman.addEventListener("click", function() {
    postavi(doberman);
})
civava.addEventListener("click", function() {
    postavi(civava);
})
separd.addEventListener("click", function() {
    postavi(separd);
})
kane.addEventListener("click", function() {
    postavi(kane);
})
dug1.addEventListener("click", function() {
    majkaA();
    povecajD(1);
})
dug2.addEventListener("click", function() {
    majkaB();
    povecajD(2);
})
dug3.addEventListener("click", function() {
    majkaC();
    povecajD(3);
})
dug4.addEventListener("click", function() {
    majkaD();
    povecajD(4);
})
dug5.addEventListener("click", function() {
    majkaE();
    povecajD(5);
})
dug6.addEventListener("click", function() {
    majkaF();
})
